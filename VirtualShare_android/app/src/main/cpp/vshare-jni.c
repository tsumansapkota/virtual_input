 ...
 */
void Java_com_ss_virtualshare_Injection_start (JNIEnv *env, jobject thiz, jstring deviceName) {
  struct input_id id = {
 ...
 */
void Java_com_ss_virtualshare_Injection_stop (JNIEnv *env, jobject thiz) {
...
void Java_com_ss_virtualshare_Injection_keydown (JNIEnv *env, jobject thiz, jint key, jint mask) {
...
void Java_com_ss_virtualshare_Injection_keyup (JNIEnv *env, jobject thiz, jint key, jint mask) {
    int translatedKey = keycode (key);
    if (translatedKey < 0) {
        // Unknown key...
        return;
...
void Java_com_ss_virtualshare_Injection_keydown2 (JNIEnv *env, jobject thiz, jint key) {
    suinput_press (uinput_fd, key);
}

void Java_com_ss_virtualshare_Injection_keyup2 (JNIEnv *env, jobject thiz, jint key) {
    suinput_release (uinput_fd, key);
}

void Java_com_ss_virtualshare_Injection_movemouse (JNIEnv *env, jobject thiz, const jint x, const jint y) {
    suinput_move_pointer (uinput_fd, x, y);
}

void Java_com_ss_virtualshare_Injection_mousedown (JNIEnv *env, jobject thiz, jint buttonId) {
    switch (buttonId){
        case 1:
            suinput_press (uinput_fd, BTN_LEFT);
            break;
        case 2:
            suinput_press (uinput_fd, BTN_RIGHT);
            break;
        case 3:
            suinput_press (uinput_fd, BTN_MIDDLE);
            break;
        default:
            break;
    }
...
void Java_com_ss_virtualshare_Injection_mouseup (JNIEnv *env, jobject thiz, jint buttonId) {
    switch (buttonId){
        case 1:
            suinput_release (uinput_fd, BTN_LEFT);
            break;
        case 2:
            suinput_release (uinput_fd, BTN_RIGHT);
            break;
        case 3:
            suinput_release (uinput_fd, BTN_MIDDLE);
            break;
        default:
            break;
    }
...
void Java_com_ss_virtualshare_Injection_mousewheel (JNIEnv *env, jobject thiz, jint x, jint y) {
